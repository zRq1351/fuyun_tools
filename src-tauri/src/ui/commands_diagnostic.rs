...
use crate::ui::commands::{
    ...
    COPY_PASTE_DEDUP_LOG_COUNT, COPY_PASTE_DEDUP_REQUEST_ID_HIT_COUNT,
    COPY_PASTE_DEDUP_TEXT_HASH_HIT_COUNT, COPY_PASTE_DEDUP_TOTAL_REQUESTS,
    COPY_PASTE_DEDUP_WINDOW_STATS,
};
...
use crate::ui::commands_writeback::{
    last_writeback_result, perf_metric_group_label, perf_metric_group_rank, perf_metric_is_slow,
};
