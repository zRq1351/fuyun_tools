...
进入「设置 → AI 设置」，添加自定义 OpenAI 兼容接口（支持 DeepSeek / 通义千问 / 小米 Mimo 等），填写 API 地址、模型名称和密钥，点击「连接测试」验证。
...
- **自定义**：添加任意 OpenAI 兼容接口（DeepSeek / 通义千问 / 小米 Mimo 等）
- **扩展**：支持任意 OpenAI 兼容接口
...
|:-----------:|:-----------:|:------------:|:--------------:|:---------:|:------------------------------:|
|  右键菜单   |    可选     | 全部可自定义 | 浅色/深色/护眼 | 中/英双语 | 启动静默检测，设置中心红点提醒 |
