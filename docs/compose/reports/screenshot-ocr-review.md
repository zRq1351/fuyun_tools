...
| `src-tauri/src/services/native_ocr.rs` | 修复+优化 | 评分负分修复、动态阈值 |
| `src-tauri/src/services/ocr_rs_engine.rs` | 优化 | 引擎缓存 |
| `src-tauri/src/ui/commands_screenshot.rs` | 优化 | 冗余编码移除 |
