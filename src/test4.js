...
const containerRef = ref({ clientWidth: 500, scrollLeft: 1500, scrollTop: 0 })
const { list, containerProps, wrapperProps } = useVirtualList(ref(Array(100).fill(1)), { itemWidth: 20 })
